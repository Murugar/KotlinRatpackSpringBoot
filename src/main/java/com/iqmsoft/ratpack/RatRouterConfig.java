...
import com.iqmsoft.RatSpringBootApp;
import com.iqmsoft.message.MessageService;
import com.iqmsoft.user.User;
import com.iqmsoft.user.UserRepository;
...
@ComponentScan(basePackageClasses = {
    RatSpringBootApp.class,
})
public class RatRouterConfig {
